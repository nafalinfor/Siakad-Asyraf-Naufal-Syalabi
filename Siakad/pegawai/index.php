            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Administrator
      ...
      <aside class="app-sidebar bg-primary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="../index.html" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Admin Uin Saizu</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
                ...
                <a href="#" class="nav-link">
                  ...
                  <p>Administrasi
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a href="./?p=bayar pdh" class="nav-link">
                          <i class="nav-icon bi bi-record-circle-fill"></i>
                          <p>Bayar PDH</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="./?p=langganan e-book" class="nav-link">
                          <i class="nav-icon bi bi-record-circle-fill"></i>
                          <p>Langganan E-book</p>
                        </a>
                      </li>
                    </ul>
                  </li>
